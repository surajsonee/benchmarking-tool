...
fetch("data-calender.json")
  ...
  .then((data) => {
    ...
    for (let i = 0; i < firstWeek.sunday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${firstWeek.sunday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < firstWeek.monday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${firstWeek.monday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < firstWeek.tuesday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${firstWeek.tuesday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < firstWeek.wednsday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${firstWeek.wednsday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < firstWeek.thursday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${firstWeek.thursday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < firstWeek.friday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${firstWeek.friday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < firstWeek.saturday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${firstWeek.saturday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < secondWeek.sunday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${secondWeek.sunday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < secondWeek.monday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${secondWeek.monday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < secondWeek.tuesday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${secondWeek.tuesday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < secondWeek.wednsday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${secondWeek.wednsday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < secondWeek.thursday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${secondWeek.thursday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < secondWeek.saturday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${secondWeek.saturday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < thirdWeek.sunday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${thirdWeek.sunday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < thirdWeek.monday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${thirdWeek.monday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < thirdWeek.tuesday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${thirdWeek.tuesday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < thirdWeek.wednsday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${thirdWeek.wednsday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < thirdWeek.thursday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${thirdWeek.thursday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < thirdWeek.saturday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${thirdWeek.saturday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < fourthweek.sunday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${fourthweek.sunday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < fourthweek.monday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${fourthweek.monday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < fourthweek.tuesday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${fourthweek.tuesday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < fourthweek.wednsday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${fourthweek.wednsday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < fourthweek.thursday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${fourthweek.thursday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < fourthweek.saturday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${fourthweek.saturday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < fifthweek.sunday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${fifthweek.sunday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < fifthweek.monday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${fifthweek.monday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < fifthweek.tuesday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${fifthweek.tuesday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < fifthweek.wednsday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${fifthweek.wednsday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < fifthweek.thursday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${fifthweek.thursday.value[i]}px"></span>`;
    }
    document.querySelector(
    ...
    for (let i = 0; i < fifthweek.saturday.value.length; i++) {
      ...
      ).innerHTML += `<span class="spancolumn" style="height:${fifthweek.saturday.value[i]}px"></span>`;
    }
    document.querySelector(
...
*/
/*
const arrayHeight = [80,75,70,95,85,65,95,70,65,80,100,95,76,65,85,76,94,68,67,86,73,90,76,64,86,94,43,98,52,44]

document.querySelectorAll('.column-content .column').forEach((item,index)=>{
  item.style.height = arrayHeight[index] + "px"
})

document.querySelectorAll('.by-time-load .column-content .column').forEach((item,index)=>{
  item.style.height = arrayHeight[index] + "px"
})
*/
/*
